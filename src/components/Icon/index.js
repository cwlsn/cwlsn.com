...
const getIconContent = (icon) => {
	...
	switch (icon) {
		case 'github':
			iconPath = `<svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
			...
			break
		case 'linkedin':
			iconPath = `<svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
...
const Icon = ({ icon, size }) => (
	<IconWrapper
		size={size}
		dangerouslySetInnerHTML={{ __html: getIconContent(icon) }}
	/>
)
